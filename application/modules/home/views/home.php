                        ...
                        <div class="col-xl-6">
                            <div class="mil-banner-text">
                                ...
                                <div class="mil-buttons-frame">
                                    <a href="<?=site_url()?>register.html" class="mil-btn mil-md mil-add-arrow">Try demo</a>
                                    <a href="<?=site_url()?>https://www.youtube.com/watch?v=gRhoYxy9Oss" class="mil-btn mil-md mil-light mil-add-play has-popup-video">Watch tutorial</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="mil-banner-img">
                                <img src="<?=base_url()?>assets/images/1.png" alt="banner" style="max-width: 135%; transform: translateX(5%)">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mil-out-frame mil-visible mil-image mil-illustration-fix mil-p-160-0">
                        <div class="row align-items-end">
                            <div class="mil-text-center">
                                ...
                                <div class="mil-up mil-mb-60"><a href="<?=site_url()?>#." class="mil-btn mil-button-transform mil-md mil-add-arrow">Protect My Purchases</a></div>
                            </div>
                        </div>
