		...
		<div class="row">
			<div class="col-xs-12">
				<div class="input-group custom_addon">
					...
					<input type="text" ng-model="search_deposit" placeholder="Search here...">
				</div>
			</div>
		</div>
	</div>
					...
					<tr dir-paginate="y in datadb_deposit | filter: search_deposit | itemsPerPage: 10">
						...
						<td>
							<a href="javascript:void(0)" ng-if="y.image" ng-click="showImage(y.image)">
								<img ng-src="<?= base_url('assets/uploads/screenshot/') ?>{{y.image}}" alt="proof" style="height:40px;">
							</a>
						</td>
						<td>{{y.created_at}}</td>
						<td>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="input-group custom_addon">
					...
					<input type="text" ng-model="search_withdraw" placeholder="Search here...">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				<img ng-src="<?= base_url('assets/uploads/screenshot/') ?>{{modalImage}}" alt="proof" style="max-width:100%;">
			</div>
		</div>
	</div>
</div>
